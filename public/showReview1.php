  ...
  <div class="container">
    ...
    <div class="donggoi">
      <div class="intro">
        <div class="row">
          <div class="col-sm-2">
            <img class="logoifo" src="images/img9.png" alt="">
          </div>
          <div class="col-sm-6">
            <h3> University of Technology and Education </span></h3>
            <h4>
              <span class="fa fa-building"></span>
              <span class="diachi">1 Võ Văn Ngân, Linh Chiểu, Thủ Đức, Hồ Chí Minh</span>
      ...
      <div class="modal fade" id="actReview" tabindex="-1" role="dialog" aria-labelledby="actReviewTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" style="max-width: 800px!important;" role="document">
          <div class="modal-content">
            ...
            <h5 class="modal-title" id="actReviewTitle">Viết Review trường đại học <input class='tentruong' type="text" name="MaTr" value="<?php echo $_GET['MaTr']?>" > <?php echo $truong =  $_GET['MaTr'] == 'SPK' ? 'SPKT' : '' ;?></h5>
